...
Edge::Edge(int point1, int point2, int UV1, int UV2, FbxVector4 normal1, FbxVector4 normal2, int polygonID) :controlPoint{ point1,point2 }, UVIndex{ UV1,UV2 }, normal{ normal1,normal2 }, polygonID(polygonID){};
